	...
	<body>
		...
		<!-- Signup Form -->
                ...
                <p>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="uname" ErrorMessage="Enter User Name" ValidationGroup="submit"></asp:RequiredFieldValidator>
                </p>
                <p>
                ...
                <p>
                    <asp:Button ID="Button1" runat="server" Text="Login" OnClick="Button1_Click" ValidationGroup="submit" />
                </p>   
                <p>
